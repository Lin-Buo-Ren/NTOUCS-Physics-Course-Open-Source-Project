# 第一個作業 - 第一章與第三章習題<br />HW#1-CH1 & CH3
...
球周長 = 2 \times 球半徑 \times \pi = 2 \times (6.37 \times 10^6公尺) \times \pi
 = 2 \times (6.37 \times 10^3公里) \times \pi \approx 4.00 \times 10^4 公里
$$
...
代入球表面積公式：  
$$
球表面積 = 4\pi 半徑 ^2 = 4\pi(6.37 × 10^3 公里)^2 \approx 5.10 \times 10^8 平方公里(km^2)
$$

#### 答案<br />Answer
約 $$ 5.10 \times 10^8 $$ 平方公里

### (c) 體積
#### 解決方案<br />Solution
代入球體積公式：
$$
球體積 = \frac{4\pi 半徑^3}{3} = \frac{4\pi (6.37 \times 10^3 公里)^3}{3} \approx 1.08 \times 10^{12} 立方公里(km^3)
$$

#### 答案<br />Answer
約 $$1.08 \times 10^{12}$$ 平方公里
